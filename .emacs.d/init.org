...
#+BEGIN_SRC emacs-lisp
;; My first attempt at elisp. Should be rewritten
...
(define-key custom-bindings-map (kbd "C-c r")  'revert-buffer)
#+END_SRC
...
(smartrep-define-key
    custom-bindings-map "C-b" '(("f" . (lambda () (interactive) (scroll-down 1)))
