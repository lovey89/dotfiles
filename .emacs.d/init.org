...
(defun cycle-themes ()
  ...
  (cond ((equal my-cur-flavor 'mocha)
         ...
         (set-face-background 'org-block "#111116")
         (set-face-attribute 'org-block-begin-line nil :background "#b4befe" :foreground "#000000")
...
Then to get the colors you can run ~M-x describe-face~.
