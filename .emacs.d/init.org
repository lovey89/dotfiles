...
(define-key custom-bindings-map (kbd "C-b 0")     'global-scale-default)
(define-key custom-bindings-map (kbd "C-b +")     'global-scale-up)
(define-key custom-bindings-map (kbd "C-b -")     'global-scale-down)
#+END_SRC
