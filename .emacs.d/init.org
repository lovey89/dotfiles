...
(let* ((package--builtins nil)
       (packages
        '(auto-compile         ; automatically compile Emacs Lisp libraries
          ...
          company-anaconda     ; Anaconda (python) backand for company
...
(add-hook 'python-mode-hook
          (lambda ()
            (set (make-local-variable 'company-backends)
                 '((company-yasnippet company-anaconda))) ; From doc string of company-yasnippet
            (company-mode)
            (anaconda-mode)))
#+END_SRC
...
(eval-after-load "company"
  '(progn
     ...
     (define-key custom-bindings-map (kbd "C-c C-SPC")  'company-complete)
